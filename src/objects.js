...
/**
 * Represents equipment in the game.
 */
...
/**
 * Represents a base battler entity.
 */
class Game_Battler {
    constructor() {
        this.hp = 0;
...
class Game_Actor extends Game_Battler {
    ...
    constructor(name) {
        ...
        Object.assign(this, d); this.name = name; this.mhp = d.hp; this.hp = this.mhp; this.mpe = 100; this.pe = d.pe;
        // this.equip, this.states initialized in super
        this.level = 1; this.exp = 0; this.nextExp = 50; this.inventory = [];
