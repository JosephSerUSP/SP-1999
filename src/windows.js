...
class UIManager {
    ...
    createLayout() {
        ...
        // Viewport (Optical Feed) - Still manual for now as it holds the game canvas
        this.windows.view = new Window_Base('view', {top:'2%', left:'23%', width:'54%', height:'96%'}, "OPTICAL FEED");
        this.windows.view.show();
        this.windows.view.contentEl.id = 'game-view-container';
        this.windows.view.contentEl.style.padding = '0';
        this.windows.view.contentEl.style.background = '#000';
        this.windows.view.contentEl.style.display = 'flex';
        this.windows.view.contentEl.style.alignItems = 'center';
        this.windows.view.contentEl.style.justifyContent = 'center';
    }
