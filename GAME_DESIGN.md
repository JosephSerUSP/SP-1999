...
*   **Stamina & PE Management:**
    ...
    *   **PE (Power Energy):** Used for Skill costs. Max 100.
    *   **Costs:**
        *   **Move:** 10 Stamina.
        *   **Action (Attack/Skill):** 20 Stamina (+ PE cost if applicable).
    *   **Regeneration:**
        *   **Inactive** party members regenerate **Stamina** (50% of the active member's expenditure).
        *   **PE** does *not* regenerate automatically for inactive members; it must be restored via items or specific effects.
...
*   **Actions:**
    ...
    *   **Bump Attack:** Moving into an enemy triggers a basic melee attack. Consumes 20 Stamina (and 0 PE).
