...
*   **Resource Management:**
    *   **Stamina** (Max 1000): The physical energy of the character.
        *   **Move**: Costs 10 Stamina.
        *   **Action**: Costs 20 Stamina (Attack, Skill, Item).
        *   **Exhaustion**: If Stamina reaches 0, the character is forcibly swapped out.
        *   **Regeneration**: Inactive party members regenerate Stamina (50% of active member's expenditure).
    *   **PE (Power Energy)**: The mental/magical energy for Skills.
        *   **Costs**: Vary by skill.
        *   **Regeneration**: Does NOT regenerate automatically. Requires Items (Stims) or specific effects.
...
*   **Actions:**
    ...
    *   **Skills:** Selected from the menu. Can target single enemies, shapes (Line, Cone, Circle), or Self. Consumes PE + 20 Stamina.
        *   **Targeting:** Starts at the active character (or first valid target for inspection).
    *   **Items:** Consumables for healing or buffs. Using an item ends the turn. Consumes 20 Stamina.
