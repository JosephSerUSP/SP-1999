...
*   **Resource Management (Stamina & PE):**
    *   **Stamina:** Used for physical exertion (Movement, Actions). Max 1000.
    *   **PE (Power Energy):** Used for Skills. Varies by character.
    *   **Regeneration:** Inactive party members regenerate **Stamina** (50% of the active member's expenditure). PE does not regenerate automatically for inactive members.
...
*   **Actions:**
    ...
    *   **Bump Attack:** Moving into an enemy triggers a basic melee attack. Consumes 20 Stamina (uses 'melee' skill, 0 PE).
    *   **Skills:** Selected from the menu. Consumes 20 Stamina + Skill Cost (PE).
        *   **Targeting:**
            *   **Target Cycle:** Cursor starts at active character or first valid target.
            *   **Directional:** Uses active character's facing direction.
...
*   **Turret:** Stationary, attacks from range (Note: Uses legacy hardcoded logic in some map updates).
