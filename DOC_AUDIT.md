...
*   **Action:** `Documents/Architecture Document.md` has been updated to mark these as deprecated legacy modals or remove them. The code has been cleaned up.
...
*   **Action:** Documentation has been updated to reflect the `cycleActive` vs `rotate` distinction.
