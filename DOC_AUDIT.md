...
**Update:** Maintenance cleanup was performed to resolve identified inconsistencies. Documentation now aligns with the codebase. References in README.md and Architecture Document were verified as already up-to-date.
